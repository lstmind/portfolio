...
export const WORKS: Work[] = [
  ...
  {
    href: "https://grillmebel.ru/",
    tag: "LIVE · Магазин",
    title: "GrillMebel",
    kind: "WooCommerce",
    text: "Магазин уличной мебели и барбекю-комплексов завода-производителя: 3D-рендеры товаров, каталог по решениям, связь со специалистом.",
    stack: ["WordPress", "WooCommerce", "Каталог"],
    img: "/img/tall/grillmebel.jpg",
    imgTall: "/img/tall/grillmebel.jpg",
    imgTallH: 1580,
    alt: "GrillMebel — магазин уличной мебели и барбекю",
  },
  {
    href: "https://siberiaproduct.com/",
    tag: "LIVE · Производитель",
    title: "Сибирь Продукт",
    kind: "Tilda",
    text: "Сайт производителя натуральных смесей для мороженого: сочная подача Алтая, продукция, раздел для оптовиков, запрос прайса.",
    stack: ["Tilda", "Лендинг", "Опт"],
    img: "/img/tall/siberia.jpg",
    imgTall: "/img/tall/siberia.jpg",
    imgTallH: 3747,
    alt: "Сибирь Продукт — производитель смесей для мороженого",
  },
  {
...
export const WORKS_INDEX: WorkIndexItem[] = [
  ...
  // сайты и лендинги
  { title: "Luxury Design", href: "https://a-interiors.ru/", cat: "Магазины", engine: "WordPress · WooCommerce", note: "Магазин американской мебели люкс-сегмента: каталог по брендам и коллекциям, поиск, корзина" },
