...
export type Review = { text: string; name: string; job: string };
...
export const REVIEWS: Review[] = [
  ...
  {
    text: "Код аккуратный, всё работает стабильно. Видно, что человек разбирается в своём деле. Коммуникация комфортная — всегда на связи, отвечает по делу без лишней воды.",
    name: "managermoon",
    job: "Доработка WordPress",
  },
];
