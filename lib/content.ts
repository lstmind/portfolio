...
export const FACTS = [
  ...
  { value: "1000", suffix: "₽", label: "в час · по проекту фикс" },
];
...
export const FAQ = [
  {
    ...
    a: "Простой лендинг — от 15 000 ₽ за 5–7 дней (3–4 экрана, кастом-дизайн, форма заявок в Telegram). Стандартный, с анимацией и проработкой — 25–50k за 7–14 дней. Точную смету называю после короткого разбора задачи. Мелкие доработки и правки — 1 000 ₽/час.",
  },
  {
