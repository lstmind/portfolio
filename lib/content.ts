...
export const SITE = {
  ...
  url: "https://lstmind.ru", // TODO: заменить на боевой домен перед SEO-фазой
  ratePerHour: 1500,
} as const;
...
export const FAQ = [
  {
    ...
    a: "Простой лендинг — от 25 000 ₽ за 5–7 дней (3–4 экрана, кастом-дизайн, форма заявок в Telegram). Стандартный, с анимацией и проработкой — 40–70k за 7–14 дней. Точную смету называю после короткого разбора задачи. Мелкие доработки и правки — 1500 ₽/час.",
  },
  {
