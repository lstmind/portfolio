...
const FAQ: { q: string; a: string }[] = [
  { q: "Сколько стоит лендинг?", a: "Простой — от 15 000 ₽ (5–7 дней). Стандартный, с анимацией — 25–50k (7–14 дней). Точную смету назову после разбора. Мелкие правки — 1 500 ₽/час." },
  ...
  { q: "Поддержка после релиза?", a: "Две недели после сдачи правлю мелочи и баги бесплатно. Дальше — по часам или на абонентке. Не из тех, кто пропадает после оплаты." },
];
...
function screenReviews(): Screen {
  return {
    text:
      "⭐ <b>Отзывы клиентов</b>\n\n" +
      "<b>5.0</b> на Kwork · 29 отзывов · 0 отрицательных\n\n" +
