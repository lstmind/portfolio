...
const SERVICES: Service[] = [
  { key: "site", emoji: "🚀", title: "Сайт под ключ", desc: "От идеи до публикации: структура, дизайн, вёрстка, формы заявок, базовое SEO. Не шаблон — под вашу задачу.", price: "от 15 000 ₽ — лендинг\n25 000–50 000 ₽ — многостраничный", term: "5–14 дней" },
  { key: "shop", emoji: "🛒", title: "Интернет-магазин", desc: "WooCommerce под ключ: каталог, фильтры, корзина, оплата и доставка. Перенос товаров, настройка под рекламу.", price: "от 35 000 ₽", term: "от 2 недель" },
  { key: "fix", emoji: "🛠", title: "Доработка / спасение сайта", desc: "Починю чужой сайт: вёрстка, баги, недоделки. Работаю на копии с бэкапом — рабочий сайт в безопасности.", price: "от 1 000 ₽/час", term: "от 1 дня" },
  { key: "speed", emoji: "⚡", title: "Ускорение сайта", desc: "Разгоняю до зелёного PageSpeed: картинки, кэш, чистка лишнего. Быстрый сайт = выше в выдаче и больше заявок.", price: "аудит бесплатно, работы от 3 000 ₽", term: "1–3 дня" },
  { key: "figma", emoji: "▦", title: "Вёрстка по Figma", desc: "Пиксель-в-пиксель из макета. Адаптив, чистый код, кроссбраузер. Без «почти как в дизайне».", price: "от 1 000 ₽ за экран", term: "от 1 дня" },
  { key: "migrate", emoji: "⇄", title: "Миграции и хостинг", desc: "Перенос между хостингами и доменами без простоя. SSL, почта, домен — всё настрою, сайт не упадёт.", price: "от 1 500 ₽", term: "1–2 дня" },
];

const FAQ: { q: string; a: string }[] = [
  { q: "Сколько стоит лендинг?", a: "Простой — от 15 000 ₽ (5–7 дней). Стандартный, с анимацией — 25–50k (7–14 дней). Точную смету назову после разбора. Мелкие правки — 1 000 ₽/час." },
